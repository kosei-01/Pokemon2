								...
								<div class="container-fluid w-100 m-5">
									<form action="action.php" method="post">
									  <div class="">   
											...
											Name<br>
											<input class="m-3 p-4 w-50 mx-auto form-control" type="text" name="pname" placeholder="Please write your pen name."><br><br>
												
											Message<br>
											<textarea class="m-3 w-75 mx-auto form-control " name="message" cols="30" rows="3" placeholder="Give us your opinion and tell us the reason if you can." required></textarea><br>
														
													<input class="text-white bg-danger m-3 w-75 mx-auto form-control" type="submit" name="send" value="Send">
                   </div>
									</form>
								</div>
              </div>
