		 ...
		 <?php
				...
				foreach($result as $rows){
					...
					echo"<tr>
					        <td>".$rows["skill_id"]."</td>
									<td>".$rows["skills"]."</td>
									<td><img style='width:90%' src=img/$pic></td>
									<td>".$rows["skills_type"]."</td>
									<td>".$rows["power"]."</td>
									<td>".$rows["accuracy"]."</td>
									<td>".$rows["physical_special"]."</td>
									<td>".$rows["skills_text"]."</td>
									<td><a href='editskills.php?id=$id'>Update</a></td>
									<td><a href='action.php?actiontype=de&id=$id'>Delete skills</a></td>
